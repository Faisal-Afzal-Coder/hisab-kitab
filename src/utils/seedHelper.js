...
const seedInitialData = async () => {
  try {
    ...
    const customer1 = new Party({
      ...
      currentBalance: 100000, // Starts with 100k receivable
    ...
    const supplier1 = new Party({
      ...
      currentBalance: -100000, // Starts with 100k payable
    ...
    const prodSugar = new Product({
      ...
      purchasePrice: 6500,
      salePrice: 7200,
      openingStock: 6, // Low stock trigger
      currentStock: 6,
      minStockAlert: 10,
    ...
    // A. Brother 2 records payment received from Ali Traders (100k -> 70k)
    ...
    // B. Brother 3 records payment made to Bilal Supplier (100k -> 70k)
    ...
    // C. Brother 1 creates a Sale Invoice
    await recordSale({
      businessId: business._id,
      user: brother1,
    ...
    // D. Brother 2 creates a Purchase Invoice
    ...
    // E. Brother 1 records an Expense
    await recordExpense({
      businessId: business._id,
      user: brother1,
